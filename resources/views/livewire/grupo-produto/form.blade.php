...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            ...
            <input type="text" id="Lucro" wire:blur="formatarValor('lucro')" wire:model="lucro" class="uppercase w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-right" placeholder="200,00">
            @error('lucro')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="lg:col-span-1">
            ...
            <input type="text" id="Comissao" wire:blur="formatarValor('comissao')" wire:model="comissao" class="uppercase w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-right" placeholder="100,00">
            @error('comissao')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
