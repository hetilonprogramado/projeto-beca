<div id="gruposContent" class="p-6 ">
    <div class="bg-white rounded-xl shadow-sm">
        <div class="p-6 border-b flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Gerenciar Grupos de Produtos</h2>
            <a href="{{route('grupo-produto.cadastrar')}}" wire:navigate class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-all">
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b">
                            ...
                            <th class="text-left py-3 px-4 font-semibold text-gray-700">Lucro</th>
                            <th class="text-left py-3 px-4 font-semibold text-gray-700">Comissão</th>
