<div id="editarProdutosContent" class="p-6">
    <div class="bg-white rounded-xl shadow-sm">
        <div class="p-6 border-b flex justify-between items-center">
            <div class="flex items-center space-x-3">
                <a href="{{route('produtos')}}" wire:navigate class="text-gray-500 hover:text-gray-700 transition-colors">
                    <i class="fas fa-arrow-left text-xl"></i>
                </a>
                <h2 class="text-xl font-semibold text-gray-800">Alterar Produto</h2>
            </div>
        ...
        <form wire:submit.prevent="atualizar" id="produtosForm" class="p-6">
            @include('livewire.produtos.form')
        </form>
    </div>
</div>
