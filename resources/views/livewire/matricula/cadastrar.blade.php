<div id="cadastroMatriculaContent" class="p-6">
    <div class="bg-white rounded-xl shadow-sm">
        <div class="p-6 border-b flex justify-between items-center">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-semibold text-gray-800">Cadastro de Matricula</h2>
            </div>
            <div class="flex space-x-3">
                ...
                <div class="flex flex-col">
                    <button type="submit" wire:click.prevent="salvar" wire:target="salvar" wire:loading.attr="disabled" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-all">
                        <span wire:loading.remove wire:target="salvar">Salvar Matricula</span>
        ...
        <form wire:submit.prevent="salvar" id="matriculaForm" class="p-6">
