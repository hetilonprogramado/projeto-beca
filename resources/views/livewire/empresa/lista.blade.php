                ...
                <table class="w-full">
                    ...
                    <tbody>
                        @foreach($empresas as $empresa)
                            @php
                                $status = strtolower($empresa->status->nome ?? '');
                                $cores = [
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4">
                                    ...
                                    <button wire:click="deletar({{ $empresa->id }})" class="text-red-500 hover:text-red-700"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
