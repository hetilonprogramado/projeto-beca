<div id="editarTurmaContent" class="p-6">
    <div class="bg-white rounded-xl shadow-sm">
        <div class="p-6 border-b flex justify-between items-center">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-semibold text-gray-800">Alterar Turma</h2>
            </div>
            <div class="flex space-x-3">
                ...
                <button type="submit" wire:click.prevent="atualizar" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-all">
                    <i class="fas fa-save mr-2"></i>Alterar Turma
                </button>
            </div>
        </div>
                    
        <form wire:submit.prevent="atualizar" id="turmaForm" class="p-6">
