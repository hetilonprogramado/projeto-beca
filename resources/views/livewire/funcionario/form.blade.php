...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div>
            ...
            <input type="date" wire:model="data_nascimento" required id="dataNascimento" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
        </div>
        ...
        <div class="lg:col-span-1">
            <label class="block text-sm font-medium text-gray-700 mb-2">Nome Mãe *</label>
            <input type="text" id="nome_mae" wire:model="nome_mae" required class="uppercase w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="Digite o nome da mãe">
            @error('nome_mae')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="lg:col-span-1">
            <label class="block text-sm font-medium text-gray-700 mb-2">Senha Compra *</label>
            <input type="text" id="senha_compra" wire:model="senha_compra" required class="uppercase w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="Digite a senha de compra">
            @error('senha_compra')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <input type="text" wire:model="telefone1" x-mask="{{ '(99) 9999-9999' }}" id="telefone1" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="(00) 00000-0000" maxlength="15">
                @error('celular')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" wire:model="telefone2" x-mask="{{ '(99) 9999-9999' }}" id="telefone2" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="(00) 00000-0000" maxlength="15">
                @error('celular')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
