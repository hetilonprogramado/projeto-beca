<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="md:col-span-1">
            ...
            <input type="text" wire:model="nome" id="nome" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="Ex: Introdução à Programação">
        </div>

        <div class="md:col-span-1">
            <label class="block text-sm font-medium text-gray-700 mb-2">Sigla *</label>
            <input type="text" wire:model="sigla" id="sigla" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="Ex: IPR">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Grupos Diciplinas *</label>
            <select id="grupoDisciplina" wire:model="grupo_disciplina_id" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                <option value="">Selecione o Grupo</option>
                @foreach ($grupo_disciplinas as $grupo)
        ...
        <div>
            ...
            <div class="relative">
                <input type="number" wire:model="hrs_aula" id="cargaHoraria" required min="1" max="2000" class="w-full px-4 py-3 pr-16 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="120">
