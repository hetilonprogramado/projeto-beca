<div id="alterarDisciplinaContent" class="p-6 ">
    <div class="bg-white rounded-xl shadow-sm">
        <div class="p-6 border-b flex justify-between items-center">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-semibold text-gray-800">Alterar Disciplina</h2>
            </div>
        ...
        <form wire:submit.prevent="atualizar" id="disciplinaForm" class="p-6">
