...
return [
    ...
    */
    ...
    'email' => 'O campo :attribute campo deve ser um endereço de e-mail válido.',
    ...
    'gt' => [
        ...
        'file' => 'O campo :attribute deve ter mais de :value quilobytes.',
        'numeric' => 'O campo :attribute deve ter mais de :value caracteres.',
    ],
    ...
    'json' => 'O campo :attribute O campo deve ser uma string JSON válida.',
    ...
    'lt' => [
        ...
        'numeric' => 'O campo :attribute deve ter menos de :value quilobytes.',
        'string' => 'O campo :attribute deve ter menos de :value caracteres.',
    ],
    'lte' => [
        'array' => 'O campo :attribute não deve ter mais de :value itens.',
        'file' => 'O campo :attribute deve ter menos ou igual a :value quilobytes.',
        'numeric' => 'O campo :attribute campo deve ser menor ou igual a :value.',
        'string' => 'O campo :attribute deve ser menor ou igual a :value caracteres.',
    ],
        'mac_address' => 'O campo :attribute deve ser um endereço MAC válido.',
    'max' => [
        'array' => 'O campo :attribute não deve ter mais de :max itens.',
        'file' => 'O campo :attribute não deve ter mais de :max quilobytes.',
        'numeric' => 'O campo :attribute não deve ter mais de :max caracteres.',
    ],
    ...
    'missing_unless' => 'O O campo :attribute deve estar ausente, a menos que :other seja :value.',
    ...
    'prohibited_if_declined' => 'O O campo :attribute é proibido quando :other é recusado.',
